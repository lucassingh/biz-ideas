...
/**
 * Adapted from react-bits' Grainient background
 * (https://reactbits.dev/backgrounds/grainient) — a WebGL shader gradient
 * with animated grain. Unchanged apart from TS lint cleanup (no `any`);
 * colors are passed in as hex props by the caller, driven by our theme
 * tokens, so this file itself has no palette baked in.
 */
